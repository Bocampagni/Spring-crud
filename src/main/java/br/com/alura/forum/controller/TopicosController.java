...
public class TopicosController {
	...
	public ResponseEntity<DetalhesDoTopicoDto> detalhar(@PathVariable Long id) {
		...
		if( topico.isPresent()) {
			return ResponseEntity.ok(new DetalhesDoTopicoDto(topico.get()));   //.get() vai pegar o topico dentro do optional
		}
	...
	@PutMapping("/{id}")
	@Transactional //Sem o transactional ele não commita para o banco de dados, as mudanças estão só em nível de memória.
